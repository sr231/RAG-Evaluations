...
class ARES:
    ...
    config_spec = {
        ...
        "ppi": {
            ...
            "checkpoints": (bool, False),  #EDITED to bool, False instead of (list, None)- shouldn't be required if llm_judge != None # Required parameter with no default value
            ...
            "vllm": (bool, False),  # Optional with default
            "azure_openai_config": (dict, {}), # Optional with default #Edit to {} instead of None
            "host_url": (str, "http://0.0.0.0:8000/v1"),  # Optional with default
            "request_delay": (int, 0),  # Optional with default
            "debug_mode": (bool, False),  # Optional with default
            ...
            #"azure_openai_config": (dict, None)  # Optional with default #Edit as this appears to be repeated in this list
        }
